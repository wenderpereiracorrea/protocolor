	...
	<form action="grava_usuario.php" method="POST" name="form" target="_self" onSubmit="javascript:return avalia(this)" >	
			<table align="center" width="50%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td><input name='novonome' type='text' id='novonome' size='40' maxlength='40' class='caixa' value='<? echo ($novonome); ?>' onClick='javascript:document.form.Gravar.style.visibility = "visible";'  onFocus='Focus(this);document.form.aviso.value="Digite o nome do usuário.";' onBlur='Blur(this);'></td>
				</tr>  
				<tr>
