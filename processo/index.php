...
for ($i = 1;$i<=2;$i++) {
$consulta = "insert into numeros
(NUM) values ('$nprocesso & $nprocessoano')";
$resultado = mysql_query($consulta)
or die ("Falha na execução da consulta");
}
				} // for
...
-->
  ...
  <td>Processo:</td>
      <td width="350">
	  <input type="text" name="nprocesso" maxlength="17"  onChange="submit();" onKeyPress='javascript:if (event.keyCode==13){ submit();};SoNumero();formatar(this, "#####.######/####")' value="<? echo $nprocesso ?>" placehoder="" >&nbsp;<input type="submit" name="gerar" value="Gerar Números"></td>
		...
		<br/>
		<tr> 
		<td colspan="6" class="caixaazul"><div align="center"><img border="0" src="../imagebox/etiqueta.png" width="30" height="30"><a href="imprimir.php" target="_blank">Etiquetas</a>
		</td>
		<br/>
		<br/>
		Para gerar a lista Excel com os números dos processos clique em gerar números e aguarde a geração dos números; <br/>
		Depois clique em etiquetas para exportar uma lista com os números gerados!
		</tr>
</form>
</HEAD>
</HTML>