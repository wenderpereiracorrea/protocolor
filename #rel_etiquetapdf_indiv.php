...
$leti = "40"; // Largura da Etiqueta (mm)
$aeti = "150"; // Altura da Etiqueta (mm)
$ehet = "0"; // Espaço horizontal entre as Etiquetas (mm)

$pdf=new FPDF('l','mm','etiqueta'); // Cria um arquivo novo com tamanho tipo carta
$pdf->Open(); // inicia documento
$pdf->AddPage(); // adiciona a primeira pagina
$pdf->SetMargins('4','4'); // Define as margens do documento
