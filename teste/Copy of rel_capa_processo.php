...
<table border="0" cellspacing="0" cellpadding="0" bordercolor="#000000" width="97%">
  ...
  <tr>
    <td width="10">&nbsp;</td>
    <td width="690"><b>
    <center><font size="3">PROC. Nº.: <? echo($nprocesso); ?></font></center></b></td>
  </tr>
  <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><b><font size="2">ANEXO: &nbsp </b> <? echo($anexos); ?>  </font> </td>
  </tr>
    <td>&nbsp;</td>
  <tr>
    <td>&nbsp;</td>
...
<center><input type="button" onClick="this.style.display='none'; window.print();" value="Imprimir" /></center>
</BODY>
<SCRIPT LANGUAGE="JavaScript">
