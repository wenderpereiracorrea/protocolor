...
<TABLE width="80%" BORDER=0 align="center" cellpadding="1" cellspacing="1">
	<tr>
	  <td width="3%" style="visibility:hidden"><center>ID</center></td><td width="20%" class="caixadestaque"><center><a href="rel_transito.php?ordem=processo">PROCESSO</a></center></td><td width="15%" class="caixadestaque"><center><a href="rel_transito.php?ordem=encaminha">ENCAMINHAMENTO</a></center></td><td width="15%" class="caixadestaque"><center><a href="rel_transito.php?ordem=destino">DESTINO</a></center></td><td width="50%" class="caixadestaque"><center>DESPACHO</center></td>
	</tr>
<? 
		...
		if (mysql_num_rows($process) > 0) {
					while ($line = mysql_fetch_array($process)) {
						...
						?>
						<tr>
							<td style="visibility:hidden"><? echo ($id); ?></td><td class="caixa"><? echo ($processo); ?></td><td class="caixa"><? echo tdate($data,1); ?></td><td class="caixa"><? echo ($destino); ?></td><td class="caixa"><? echo ($despacho); ?></td>
						</tr>
						<?
					}
		}
