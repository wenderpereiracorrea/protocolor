...
// AUTO COMPLETAR LOCAL ********************************
if ($_GET[tabela] == "setor") {
...
$Resultado = mysql_query($sql) or die("Erro: "); 
		...
		if (mysql_num_rows($Resultado) > 0) {
			...
			$items[$i] = utf8_encode($array_exibir['setor']);
			
			$i++;

//				$items = array("Teste"=>"'.$array_exibir['nome'].'");
...
// AUTO COMPLETAR EDITORES ********************************
if ($_GET[tabela] == "especie") {
...
$Resultado = mysql_query($sql) or die("Erro: ");
		if (mysql_num_rows($Resultado) > 0) {
			...
			$items[$i] = utf8_encode($array_exibir['especie']);
...
// AUTO COMPLETAR PESQUISA ********************************
if ($_GET[tabela] == "pesquisa") {
...
/*$items = array(
"Ronaldo <em>Bittern</em>"=>"Ronaldo Lucena",
