		...
		<?	if (mysql_num_rows($process) > 0 && mysql_num_rows($process) == 1) 
				{ $listaproc=1;
					...
					<tr style="visibility:hidden"><td><input type="text" name="up" id="up"></td></tr><tr style="visibility:hidden"><td><input type="text" name="processo" id="processo"></td></tr><tr style="visibility:hidden"><td><input type="text" name="ano" id="ano"></td></tr><tr style="visibility:hidden"><td><input type="text" name="processo_old" id="processo_old" value="<? echo $nprocesso; ?>"></td></tr>
						...
						<tr> 
							<td class="caixadestaque">Assunto :</td><td><textarea name="assunto" cols="100%" size="12" rows="1" wrap="hard" class="caixa"><? echo utf8_encode (ucwords(strtoupper($assunto))); ?></textarea ></td>
						</tr>
						<tr> 
						<tr> 
							<td class="caixadestaque">Favorecido :</td><td><textarea name="favorecido" cols="50%" rows="1" wrap="hard" class="caixa"><? echo utf8_encode (ucwords(strtoupper($favorecido))); ?></textarea ></td>
						</tr>
						<tr> 
						...
						<tr> 
							<td class="caixadestaque">Procedência :</td><td class="caixatitpesq"><input name="procedencia" type="text" value="<? echo utf8_encode (ucwords(strtoupper($procedencia))); ?>" size="80%" ></td>
						</tr>
						<tr> 
...
<? if ($localizacao!="") {
		...
		if (mysql_num_rows($processB) > 0) {
					echo "<option value='$localizacao'>".utf8_encode ($localizacao)."</option>\n";
		...
		<? if ($processored=="") 
			...
			<tr align='center'> 
				<td><div align="center">Processo:&nbsp;&nbsp;
					...
					onkeyup='Mostra(this, 17)'>
					<input type="submit" name="localizar" value="localizar" style="color:#006600" onClick="onChange="form.submit();">&nbsp;
